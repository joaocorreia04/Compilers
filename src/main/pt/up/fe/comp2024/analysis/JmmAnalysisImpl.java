...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    public JmmAnalysisImpl() {
        ...
        this.analysisPasses = List.of(new UndeclaredVariable(), new BinaryOp(), new ArrayAccess(), new BooleanOp(), new AssignmentCheck(), new Conditional(), new ReturnCheck(), new MethodCheck(), new Static());
